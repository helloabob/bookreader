 ...
 *  addCallback(), removeCallback(), and getActive() (and probably more in the future). It is
 *  the ultimate sequencing tool. Think of a TimelineMax instance like a virtual MovieClip 
 *  timeline or a container where you place tweens (or other timelines) over the course of time.
 *  You can:
 * 	
 * <ul>
 ...
 * 		  every other cycle. 
 * 		
 * 		<li> listen for START, UPDATE, REPEAT, REVERSE_COMPLETE, and COMPLETE events.
 * 		
 ...
 * 			the "virtual playhead" passes a particular spot.
 * 	</ul>
 * 	
 ...
 * 	
 * 		var myTimeline:TimelineMax = new TimelineMax({tweens:[[mc1, 1, {y:"100"}], [mc2, 1, {y:"120"}]], align:TweenAlign.SEQUENCE, onComplete:myFunction, repeat:2, repeatDelay:1});</code><br /><br />
 * 	
 ...
 **/
	public class TimelineMax extends TimelineLite implements IEventDispatcher {
		...
		public function removeCallback(callback:Function, timeOrLabel:*=null):Boolean {
			var a:Array = getTweensOf(callback, false), i:int, success:Boolean;
			...
			for (i = a.length - 1; i > -1; i--) {
				if (timeOrLabel == null || a[i].cachedStartTime == timeOrLabel) {
